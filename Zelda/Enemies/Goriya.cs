...
namespace Zelda.Enemy
{
    public class Goriya : IEnemy
    {
        ...
        private Texture2D texture = TextureStorage.GetTexture(TextureStorage.SpriteSheet.Goriya);
       ...
       // public Rectangle DestinationLocation { get { return destinationRectangle; } set { } }
        ...
        public Goriya()
        {
            texture = TextureStorage.GetTexture(TextureStorage.SpriteSheet.Goriya);
            WIDTH = 65;//texture.Width / COLUMNS;
            HEIGHT = 64;//texture.Height / ROWS;
