...
namespace Zelda.Sprites.Classes
{
    public class Sprite : ISprite
    {
        ...
        public Sprite(Texture2D texture) : this(texture, 0, 0, texture.Width, texture.Height, -1) { }

        public Sprite(Texture2D texture, double sizeInBlocks) : this(texture, 0, 0, texture.Width, texture.Height, sizeInBlocks) { }

        public Sprite(Texture2D texture, int x, int y, int width, int height) : this(texture, x, y, width, height, -1) { }
